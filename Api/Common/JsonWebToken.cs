...
namespace Api.Common
{
    ...
    public class JsonWebToken
    {
        ...
        public static string Encode(object payload, byte[] keyBytes, JwtHashAlgorithm algorithm)
        {
            ...
            #region Make signature
            RsaKeyParameters rsaParameters;
            var asymmetricKeyParameter = PrivateKeyFactory.CreateKey(keyBytes);

            rsaParameters = asymmetricKeyParameter as RsaKeyParameters;

            var signer = SignerUtilities.GetSigner("SHA256withRSA");

            signer.Init(true, rsaParameters);
            ...
            #endregion
            #region Create JWT
            segments.Add(Base64UrlEncode(signed));
